// financial_repositories.dart
// Enterprise Clean Architecture repository contracts & implementations for Financial Core in MASARI
...
class MockWalletRepository implements WalletRepository {
  ...
  MockWalletRepository() {
    // Seed database with a demo wallet for our live user (usr-101)
...
class MockTransactionRepository implements TransactionRepository {
  ...
  MockTransactionRepository() {
    // Seed initial financial history for full verification
